...
@section("content")
	{!! Form::open([
		...
		<div class="post-preview flex-column row-page row-compact row-blank"></div>

		<div class="forum-post row-page row-compact flex-full flex-column" data-post-position="1">
			...
			<div class="topics-create-footer reply-box-footer">
